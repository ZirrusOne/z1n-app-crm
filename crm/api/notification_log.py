...
def send_notification_email(doc):
	print(f"---------send_notification_email {send_notification_email}")
	...
	print(f"-------------------------args {args} {args["doc_link"]}")
...
def get_email_header(doc, language: str | None = None):
	...
	# print(f"doc.document_name {doc.document_name} doc.document_type {doc.document_type}")
	# if doc.document_type == "CRM Lead":
	# 	print(f"--------------------doc.lead_name {doc.lead_name}")
	# 	docname = doc.document_type +:+ doc.lead_name
	header_map = {
